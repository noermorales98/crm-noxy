...
export const authConfig = {
  ...
  callbacks: {
    authorized({ auth, request: { nextUrl } }) {
      ...
      const isPublicPage = pathname.startsWith("/form/") || pathname.startsWith("/schedule/") || pathname.startsWith("/book/") || pathname.startsWith("/docs/") || pathname.startsWith("/cotizar/") || pathname.startsWith("/calendario/");
