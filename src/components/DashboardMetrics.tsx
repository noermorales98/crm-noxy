  ...
  return (
    <div className="grid grid-cols-12 gap-6 bg-transparent">
      ...
      <div className="col-span-5 bg-transparent p-1 pl-4 flex flex-col justify-end h-40">
        <h3 className="text-gray-900 font-semibold mb-4">New customers</h3>
        <div className="flex items-end h-24 gap-[10%]">
          ...
          <div className="w-[12%] flex flex-col items-center gap-2">
            ...
            <span className="text-xs font-semibold text-gray-500">Mon</span>
          </div>
          <div className="w-[12%] flex flex-col items-center gap-2">
            ...
            <span className="text-xs font-semibold text-gray-500">Tue</span>
          </div>
          <div className="w-[12%] flex flex-col items-center gap-2">
            ...
            <span className="text-xs font-semibold text-gray-500">Wed</span>
          </div>
          <div className="w-[12%] flex flex-col items-center gap-2">
            <div className="w-full h-8 bg-[#2d2d2d] rounded-sm"></div>
            <span className="text-xs font-semibold text-gray-500">Thu</span>
          </div>
          <div className="w-[12%] flex flex-col items-center gap-2">
            <div className="w-full h-[85px] bg-[#2d2d2d] rounded-sm relative">
                {/* Y-axis labels over background */}
                <div className="absolute -left-12 bottom-0 text-[10px] text-gray-400 font-medium">0</div>
                <div className="absolute -left-12 bottom-[50%] text-[10px] text-gray-400 font-medium">5</div>
                <div className="absolute -left-12 bottom-[80%] text-[10px] text-gray-400 font-medium">10</div>
            </div>
      ...
      <div className="col-span-3 flex items-center justify-center p-4 relative">
        ...
        <div className="absolute bottom-4 flex flex-col items-center">
          ...
          <div className="text-xs text-gray-500 font-medium mt-1">Successful deals</div>
        </div>
      </div>
      ...
      <div className="col-span-2 flex flex-col justify-end p-4 pb-0 h-40 group cursor-pointer">
        <div className="mb-auto">
          <div className="text-4xl font-bold text-gray-900 mb-2">53</div>
      ...
      <div className="col-span-2 flex flex-col justify-end p-4 pb-0 h-40 group cursor-pointer">
        <div className="mb-auto">
          <div className="text-4xl font-bold text-gray-900 mb-2">$ 15.890</div>
