    ...
    <div className="flex flex-col gap-5">
      ...
      {editMode && !pickerOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 z-30 px-4 py-2.5 rounded-full bg-action-primary text-action-primary-foreground text-xs font-medium shadow-lg hover:opacity-90"
        >
