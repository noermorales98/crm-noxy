...
export const CRM_SEARCH_PAGES: CrmSearchPage[] = [
  ...
  { id: "nav-pipeline", title: "Pipeline de ventas", subtitle: "Ventas", href: "/pipeline", keywords: ["ventas", "pipeline", "deals", "oportunidades"] },
  { id: "nav-pipeline-clientes", title: "Clientes", subtitle: "Cobros recurrentes", href: "/pipeline/clientes", keywords: ["clientes", "recurrente", "mrr", "cobros", "ventas"] },
